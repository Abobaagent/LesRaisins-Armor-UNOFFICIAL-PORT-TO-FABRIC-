...
public class BedrockArmorRenderer extends GeoArmorRenderer<LrArmorItem> {
	private static final ResourceLocation animationLocation = new ResourceLocation(ModConstants.MOD_ID, "animations/item/armor/default.animation.json");
	public BedrockArmorRenderer(String suit) {
		super(new DefaultedItemGeoModel<>(new ResourceLocation(ModConstants.MOD_ID, "armor/"+suit)){
			@Override
